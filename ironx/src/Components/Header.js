                    ...
                    <li className="nav-item">
                        ...
                        <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                            <div className="bg-white py-2 collapse-inner rounded">
                                ...
                                <a className="collapse-item"> <LinkContainer to='/api/seller'>
                                    <NavDropdown.Item>Seller Account</NavDropdown.Item>
                                </LinkContainer></a>
                                <a className="collapse-item" > <LinkContainer to='/api/customer'>
                                    <NavDropdown.Item> Customer Account </NavDropdown.Item>
                                </LinkContainer></a>
                            </div>
                        </div>
