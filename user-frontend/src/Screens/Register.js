...
export default connect(mapStateToProps)(withRouter(class RegisterScreen extends React.Component {
    ...
    handelSubmit = (e) => {
        ...
        try {
            ...
            if (this.state.password == this.state.confirmpassword) {
                store.dispatch(registerAction(this.state.name, this.state.password, this.state.email))
            }
